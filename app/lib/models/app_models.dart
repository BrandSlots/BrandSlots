...
class MediaPlaybackStat {
  ...
  /// Per-media play count (used for video/image breakdown in reports).
  final int playCount;
  ...
  /// Round count — only populated when mediaId == '__round__'.
...
class ScreenMediaAssignment {
  const ScreenMediaAssignment({
    required this.id,
    required this.screenId,
    required this.mediaId,
    required this.assignedAtRound,
    this.removedAtRound,
  });
  ...
  final String screenId;
  final String mediaId;
  final int assignedAtRound;
  final int? removedAtRound;

  ScreenMediaAssignment copyWith({
    String? id,
    String? screenId,
    String? mediaId,
    int? assignedAtRound,
    ...
    return ScreenMediaAssignment(
      id: id ?? this.id,
      screenId: screenId ?? this.screenId,
      mediaId: mediaId ?? this.mediaId,
      assignedAtRound: assignedAtRound ?? this.assignedAtRound,
      removedAtRound: clearRemovedAt ? null : (removedAtRound ?? this.removedAtRound),
    );
  }
  ...
  Map<String, dynamic> toJson() => {
    ...
    'screenId': screenId,
    'mediaId': mediaId,
    'assignedAtRound': assignedAtRound,
    'removedAtRound': removedAtRound,
  };

  factory ScreenMediaAssignment.fromJson(Map<String, dynamic> json) =>
      ScreenMediaAssignment(
        id: json['id'] as String? ?? '',
        screenId: json['screenId'] as String? ?? '',
        mediaId: json['mediaId'] as String? ?? '',
        assignedAtRound: (json['assignedAtRound'] as num?)?.toInt() ?? 0,
        removedAtRound: (json['removedAtRound'] as num?)?.toInt(),
      );
}
...
class AppData {
  ...
  final List<ScreenMediaAssignment> assignments;
  ...
  AppData copyWith({
    ...
    List<ScreenMediaAssignment>? assignments,
  }) {
    return AppData(
  ...
  factory AppData.fromJson(Map<String, dynamic> json) {
    return AppData(
      ...
      assignments: (json['assignments'] as List<dynamic>? ?? const [])
          .map((item) => ScreenMediaAssignment.fromJson(item as Map<String, dynamic>))
          .toList(),
    );
  }
