...
abstract class AppRepository {
  ...
  Future<void> recordMediaAssigned({required String screenId, required String mediaId, required int atRound});
  Future<void> recordMediaRemoved({required String screenId, required String mediaId, required int atRound});
